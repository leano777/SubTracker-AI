    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="text-center">
          ...
          <p className="mt-2 text-primary">Loading SubTracker AI...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-gray-50">
        <div className="max-w-md w-full space-y-8">
          <div className="text-center">
            <h1 className="text-3xl font-bold text-primary">SubTracker AI</h1>
            <p className="mt-2 text-primary">Manage your subscriptions efficiently</p>
          </div>
      ...
      <header className="bg-white shadow">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <h1 className="text-2xl font-bold text-primary">SubTracker AI</h1>
            <div className="flex items-center space-x-4">
              <span className="text-sm text-primary">Welcome, {user.email}</span>
