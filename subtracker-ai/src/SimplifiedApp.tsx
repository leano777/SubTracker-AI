...
import { WeeklyPaycheckTracker } from './components/income/WeeklyPaycheckTracker';
          ...
          <div className="p-4">
            ...
            <nav className="space-y-2">
              ...
              <Button
                ...
                className="w-full justify-start"
                onClick={() => setActiveView('income' as any)}
              >
                <DollarSign className="w-5 h-5" />
                {isSidebarOpen && <span className="ml-3">Weekly Income</span>}
              </Button>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <h1 className="text-3xl font-bold text-primary dark:text-white">
                      Weekly Paycheck Tracker
                    </h1>
                    <p className="text-primary dark:text-muted mt-1">
                      Track your weekly income and see how it affects your monthly budget
                    </p>
                  </div>
                </div>
                <WeeklyPaycheckTracker />
              </div>
            )}
