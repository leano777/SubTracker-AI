...
export const createMockSubscription = (overrides: Partial<FullSubscription> = {}): FullSubscription => ({
  id: 'test-sub-1',
...
export const createMockPaymentCard = (overrides: Partial<FullPaymentCard> = {}): FullPaymentCard => ({
  id: 'test-card-1',
  name: 'Test Card',
  lastFourDigits: '1234',
  expiryMonth: 12,
...
export const mockSession = {
  access_token: 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InRlc3QtcmVmIiwicm9sZSI6ImF1dGhlbnRpY2F0ZWQiLCJpYXQiOjE2OTkxMjgwMDAsImV4cCI6MTk5OTEzMjgwMCwic3ViIjoidGVzdC11c2VyLWlkIiwiZW1haWwiOiJ0ZXN0QGV4YW1wbGUuY29tIn0.test-signature',
  token_type: 'bearer',
  expires_in: 3600,
