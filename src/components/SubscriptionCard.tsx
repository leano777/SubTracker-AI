    ...
    switch (subscription.planType) {
      ...
      case "trial":
        const daysLeft = subscription.trialEndDate
          ? getDaysUntilTrialEnd(subscription.trialEndDate)
          : 0;
        return {
          ...
          <div className="flex-1 min-w-0">
            <div className="space-y-1">
              <div className="flex items-center gap-2 flex-wrap">
                ...
                {planTypeInfo && (
                  <Badge
                    className={`${planTypeInfo.color} flex items-center gap-1 text-xs px-2 py-0.5 flex-shrink-0`}
                  >
                    {planTypeInfo.icon}
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <span>
              {subscription.planType === "free"
                ...
                : subscription.planType === "trial"
                  ? `Trial ends: ${formatDate(subscription.trialEndDate || subscription.nextPayment)}`
          ...
          <div className="flex items-center justify-between">
            ...
            {subscription.planType === "free" ? (
              ...
              <Badge
                variant={
                  getDaysUntilTrialEnd(subscription.trialEndDate) <= 3 ? "destructive" : "outline"
                }
                className={
                  getDaysUntilTrialEnd(subscription.trialEndDate) <= 3
                    ? ""
              ...
              >
                {getDaysUntilTrialEnd(subscription.trialEndDate) <= 0
                  ? "Trial ended"
