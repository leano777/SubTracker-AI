  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent
        ...
        aria-describedby={SUBSCRIPTION_DETAILS_DESCRIPTION_ID}
      >
        <DialogHeader>
          ...
          <DialogDescription id={SUBSCRIPTION_DETAILS_DESCRIPTION_ID}>
            View detailed information about your subscription including cost breakdown, payment
            schedule, and manage subscription settings.
          </DialogDescription>
        </DialogHeader>
              ...
              <CardContent>
                <div className="space-y-3">
                  <div>
                    ...
                    {daysUntilPayment >= 0 && (
                      <div
                        className={`text-sm ${daysUntilPayment <= 7 ? "text-orange-600" : "text-muted-foreground"}`}
                      >
                        {daysUntilPayment === 0
                          ? "Due today"
                          : daysUntilPayment === 1
          ...
          <div className="flex flex-wrap gap-3">
            ...
            {subscription.status === "active" && onCancel && (
              <AlertDialog>
                <AlertDialogTrigger asChild>
                  <Button
                    variant="outline"
                    className="flex-1 min-w-[120px] text-orange-600 border-orange-200 hover:bg-orange-50"
                  >
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Are you sure you want to cancel "{subscription.name}"? This will mark it as
                      cancelled and remove it from your active subscriptions. You can reactivate it
                      later if needed.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
            ...
            <AlertDialog>
              <AlertDialogTrigger asChild>
                <Button
                  variant="outline"
                  className="flex-1 min-w-[120px] text-destructive border-destructive/20 hover:bg-destructive/5"
                >
              ...
              <AlertDialogContent>
                <AlertDialogHeader>
                  ...
                  <AlertDialogDescription>
                    Are you sure you want to permanently delete "{subscription.name}"? This action
                    cannot be undone.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
