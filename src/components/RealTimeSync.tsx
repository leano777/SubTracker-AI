    ...
    <div className="space-y-4">
            ...
            <div className="flex items-center space-x-3">
              <div className="flex items-center space-x-2">
                ...
                <div>
                  ...
                  <div className="text-sm text-muted-foreground">{getSyncStatusText()}</div>
                </div>
              </div>
      ...
      {syncStatus.conflicts.length > 0 && (
        <Alert variant="destructive">
          ...
          <AlertDescription>
            {syncStatus.conflicts.length} sync conflict{syncStatus.conflicts.length > 1 ? "s" : ""}{" "}
            detected. Please resolve to continue syncing.
            <div className="mt-2">
      ...
      {!syncStatus.isOnline && (
        <Alert>
          ...
          <AlertDescription>
            ...
            <div className="mt-2">
              <Badge variant="secondary">{syncStatus.pendingChanges} changes queued for sync</Badge>
            </div>
          </AlertDescription>
        </Alert>
      )}
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between mb-3">
              ...
              <Badge variant="outline">
                {syncStatus.collaborators.filter((c) => c.status === "online").length} of{" "}
                {syncStatus.collaborators.length} online
              </Badge>
            </div>
