...
const cardColors = [
  { name: 'Ocean Blue', value: '#3B82F6', bgClass: 'bg-blue-500', gradient: 'from-blue-500 to-blue-600' },
  { name: 'Emerald Green', value: '#10B981', bgClass: 'bg-green-500', gradient: 'from-green-500 to-green-600' },
  { name: 'Royal Purple', value: '#8B5CF6', bgClass: 'bg-purple-500', gradient: 'from-purple-500 to-purple-600' },
  { name: 'Crimson Red', value: '#EF4444', bgClass: 'bg-red-500', gradient: 'from-red-500 to-red-600' },
  { name: 'Sunset Orange', value: '#F97316', bgClass: 'bg-orange-500', gradient: 'from-orange-500 to-orange-600' },
  { name: 'Rose Pink', value: '#EC4899', bgClass: 'bg-pink-500', gradient: 'from-pink-500 to-pink-600' },
  { name: 'Indigo Blue', value: '#6366F1', bgClass: 'bg-indigo-500', gradient: 'from-indigo-500 to-indigo-600' },
  { name: 'Slate Gray', value: '#6B7280', bgClass: 'bg-gray-500', gradient: 'from-gray-500 to-gray-600' },
];

const cardIssuers = [
  'Visa', 'Mastercard', 'American Express', 'Discover', 'Chase', 'Capital One', 
  'Bank of America', 'Wells Fargo', 'Citi', 'Apple Card', 'Other'
];
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      ...
      >
        ...
        <div className={`bg-gradient-to-br ${selectedColor.gradient} rounded-2xl p-6 h-40 relative overflow-hidden shadow-lg`}>
          {/* Glass overlay effect */}
          <div className="absolute inset-0 bg-white/10 backdrop-blur-sm"></div>
          <div className="relative z-10 h-full flex flex-col justify-between text-white">
            <div className="flex justify-between items-start">
              <div className="text-lg font-bold">
                {formData.nickname || 'Card Nickname'}
              </div>
      ...
      <div className="space-y-4">
        <div>
          <Label htmlFor="nickname" className="text-white/90">Card Nickname *</Label>
          <Input
            id="nickname"
        ...
        <div>
          <Label htmlFor="lastFour" className="text-white/90">Last 4 Digits *</Label>
          <Input
            id="lastFour"
          ...
          />
          {errors.lastFour && (
            <p className="text-sm text-red-400 mt-1">{errors.lastFour}</p>
          )}
        </div>

        <div className="grid grid-cols-2 gap-4">
          <div>
            <Label htmlFor="type" className="text-white/90">Card Type</Label>
            <Select
              value={formData.type}
            ...
            >
              <SelectTrigger 
                className="bg-white/15 backdrop-blur-sm text-white border-white/20 focus:border-white/40 mt-2 rounded-lg"
              >
                <SelectValue />
              </SelectTrigger>
              <SelectContent 
                className="rounded-3xl border-white/20"
                style={glassSecondaryStyles}
              >
          ...
          <div>
            <Label htmlFor="issuer" className="text-white/90">Issuer</Label>
            <Select
        ...
        <div>
          <Label htmlFor="color" className="text-white/90">Card Color</Label>
