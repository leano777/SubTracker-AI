...
export function BudgetAllocation({ 
  ...
  const progressPercentage = selectedWeek.totalBudget > 0 ? (selectedWeek.allocated / selectedWeek.totalBudget) * 100 : 0;
        ...
        <CardContent className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <div className="space-y-2">
              ...
              <div className="text-2xl font-bold text-blue-600">{formatCurrency(selectedWeek.allocated)}</div>
            </div>
            
            <div className="space-y-2">
              <Label className="text-sm text-muted-foreground">Spent</Label>
              <div className="text-2xl font-bold text-orange-600">{formatCurrency(spentAmount)}</div>
            </div>
            
            <div className="space-y-2">
              <Label className="text-sm text-muted-foreground">Remaining</Label>
              <div className="text-2xl font-bold text-green-600">{formatCurrency(selectedWeek.remaining)}</div>
            </div>
          </div>
