...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn("text-muted-foreground px-2 py-1.5 text-xs", "stealth-ops:text-gray-400 stealth-ops:font-mono stealth-ops:tracking-wide stealth-ops:font-bold", className)}
      {...props}
    />
  );
}
