...
const categories = [
  'Entertainment', 'Productivity', 'Business', 'Design', 'Developer Tools', 
  'Health & Fitness', 'Education', 'News & Media', 'Music', 'Gaming', 
  'Finance', 'Security', 'Storage', 'Communication', 'Social Media',
  'AI & Tools', 'Insurance', 'Health & Wellness'
];
...
export function SubscriptionForm({ 
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const subscriptionData: Omit<FullSubscription, 'id'> = {
      ...
      variablePricing: formData.billingCycle === 'variable' ? {
        isVariable: true,
          ...
          <CardContent className="space-y-4">
            <div className="flex items-start space-x-2 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
              ...
              <div className="text-sm text-blue-700 dark:text-blue-300">
                <p>Define when your subscription cost will change. This helps with accurate budget planning.</p>
              </div>
            </div>
          ...
          {selectedCard && (
            <div className="mt-2 p-2 bg-muted rounded-lg">
              <div className="flex items-center space-x-2 text-sm">
                ...
                {selectedCard.isDefault && <Badge variant="secondary" className="text-xs">Default</Badge>}
              </div>
            </div>
          )}
        </div>
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          ...
          <Select 
            ...
            onValueChange={(value: 'personal' | 'business') => setFormData({ ...formData, subscriptionType: value })}
          >
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
        ...
        <div>
          ...
          <Select 
            ...
            onValueChange={(value: 'free' | 'paid') => setFormData({ ...formData, planType: value })}
          >
            <SelectTrigger>
              <SelectValue />
            </SelectTrigger>
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center space-x-3">
            ...
            <div className="grid gap-1.5 leading-none">
              <Label htmlFor="hasLinkedCard" className="text-sm font-medium leading-none cursor-not-allowed opacity-70">
          ...
          <div className="flex items-center space-x-3">
            ...
            />
            <div className="grid gap-1.5 leading-none">
              <Label htmlFor="automationEnabled" className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex items-center space-x-1">
          ...
          <div className="flex items-start space-x-2 p-3 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            <AlertCircle className="w-4 h-4 text-blue-600 mt-0.5 flex-shrink-0" />
            <div className="text-sm text-blue-700 dark:text-blue-300">
              <p>These settings help you track which subscriptions have payment methods and automation configured, making it easier to manage your services.</p>
            </div>
          </div>
        </CardContent>
      </Card>
