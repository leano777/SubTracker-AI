import { MoreHorizontal, Edit2, Trash2, Building, User, ExternalLink, Eye, Plus, Star } from 'lucide-react';
...
export function WatchlistCard({ subscription, onEdit, onDelete, onViewDetails, onActivate }: WatchlistCardProps) {
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            {subscription.dateAdded && (
              <span>on {formatDate(subscription.dateAdded)}</span>
            )}
          </div>
