...
import { Settings, CreditCard, Download, Upload, Trash2, Shield, Bell, Moon, Sun, RotateCcw, AlertTriangle, FileText } from 'lucide-react';
...
export function ManagementTab({
      ...
      <Card style={glassStyles}>
        <CardHeader>
          <CardTitle className={`flex items-center ${textPrimary}`}>
            {settings.preferences.darkMode ? <Moon className="w-5 h-5 mr-2" /> : <Sun className="w-5 h-5 mr-2" />}
            Appearance
          </CardTitle>
        </CardHeader>
        <CardContent>
          <div className="flex items-center justify-between">
            <Label htmlFor="dark-mode" className={textPrimary}>Dark Mode</Label>
            <Switch
              id="dark-mode"
  ...
  const renderNotifications = () => (
    <Card style={glassStyles}>
      ...
      <CardContent className="space-y-4">
        <div className="flex items-center justify-between">
          <Label htmlFor="upcoming-payments" className={textPrimary}>Upcoming Payments</Label>
          <Switch
        ...
        <div className="flex items-center justify-between">
          <Label htmlFor="high-spending" className={textPrimary}>High Spending Alerts</Label>
          <Switch
            id="high-spending"
        ...
        <div className="flex items-center justify-between">
          <Label htmlFor="trial-expirations" className={textPrimary}>Trial Expirations</Label>
          <Switch
        ...
        <div className="space-y-2">
          <Label htmlFor="high-spending-amount" className={textPrimary}>High Spending Threshold</Label>
          <Input
        ...
        <div className="space-y-2">
          <Label htmlFor="upcoming-days" className={textPrimary}>Upcoming Payment Alert (days)</Label>
          <Input
            id="upcoming-days"
            type="number"
  ...
  const renderDataManagement = () => (
    <div className="space-y-6">
      ...
      <Card style={{
        ...
        <CardHeader>
          <CardTitle className={`flex items-center ${isDarkMode ? 'text-red-400' : 'text-red-600'}`}>
        ...
        <CardContent className="space-y-4">
          <div className={`p-4 rounded-lg ${
            ...
            <p className={`text-sm mb-3 ${
              ...
              Clear all subscription data, payment cards, and reset settings to defaults. This action cannot be undone.
            </p>
            ...
            <AlertDialog>
              ...
              >
                <AlertDialogHeader>
                  <AlertDialogTitle className={textPrimary}>Are you absolutely sure?</AlertDialogTitle>
                  <AlertDialogDescription className={textMuted}>
                    This will permanently delete all your subscriptions, payment cards, settings, and notifications. 
                    This action cannot be undone. Consider exporting your data first.
                  </AlertDialogDescription>
                </AlertDialogHeader>
                <AlertDialogFooter>
                  <AlertDialogCancel className={`${
                    isDarkMode ? 'bg-gray-600 hover:bg-gray-500 text-gray-100' : 'bg-gray-100 hover:bg-gray-200 text-gray-900'
                  } border-0`}>
                    Cancel
                  </AlertDialogCancel>
                  <AlertDialogAction 
  ...
  const renderAdvanced = () => (
    <Card style={glassStyles}>
      ...
      <CardContent className="space-y-4">
        <div className="flex items-center justify-between">
          <Label htmlFor="show-cancelled" className={textPrimary}>Show Cancelled Subscriptions</Label>
          <Switch
            id="show-cancelled"
        ...
        <div className="flex items-center justify-between">
          <Label htmlFor="show-favicons" className={textPrimary}>Show Service Favicons</Label>
          <Switch
            id="show-favicons"
        ...
        <div className="flex items-center justify-between">
          <Label htmlFor="group-by-category" className={textPrimary}>Group by Category</Label>
          <Switch
