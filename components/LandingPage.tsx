...
import { Brain, BarChart3, Zap, Shield, Users, ChevronRight, Play, Star, Info, ExternalLink } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Get intelligent recommendations to optimize your subscription spending and reduce costs automatically.'
    },
    {
      icon: BarChart3,
      title: 'Advanced Analytics',
      description: 'Visualize your spending patterns with comprehensive charts and forecasting tools.'
    },
    {
      icon: Zap,
      title: 'Smart Automation',
      description: 'Set up intelligent rules to automatically manage renewals, cancellations, and budget alerts.'
    },
    {
      icon: Shield,
    ...
    },
    {
      ...
      description: 'Share and manage subscriptions with team members or family with role-based permissions.'
    },
    {
      icon: ChevronRight,
  ...
  const testimonials = [
    {
      ...
      avatar: '👩‍💼',
      content: 'SubTracker AI helped me reduce our monthly SaaS costs by 35%. The AI insights are incredibly accurate!'
    },
    {
      name: 'Michael Rodriguez',
      role: 'Product Manager',
      avatar: '👨‍💻',
      content: 'The automation features are game-changing. I never miss a renewal or overpay for unused services anymore.'
    },
    {
      name: 'Emily Johnson',
      role: 'Finance Director',
      avatar: '👩‍💼',
      content: 'Perfect for enterprise use. The collaboration features and security give us complete peace of mind.'
    }
  ];
      ...
      <header className="border-b border-border/40 bg-background/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <Button onClick={() => setShowAuthModal(true)} className="bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700">
              Get Started
            </Button>
          </div>
        </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  <p className="text-sm text-blue-700 dark:text-blue-300">
                    Email/password authentication is available. To enable Google sign-in, configure OAuth in Supabase.
                  </p>
                </div>
                <Button
                  variant="outline"
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8 max-w-2xl mx-auto">
              Stop overpaying for unused subscriptions. SubTracker AI uses advanced analytics and automation 
              to help you optimize costs, prevent overspend, and never miss important renewals.
            </p>
        ...
        <div className="container mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Everything you need to manage subscriptions efficiently and reduce costs with AI-driven insights.
            </p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <Card key={index} className="border-0 shadow-lg hover:shadow-xl transition-shadow duration-300 bg-background/60 backdrop-blur-sm">
        ...
        <div className="container mx-auto text-center">
          <div className="max-w-2xl mx-auto text-white">
            ...
            <p className="text-xl text-blue-100 mb-8">
              Join thousands of users who have reduced their subscription costs by an average of 32% with SubTracker AI.
            </p>
            <Button 
              size="lg" 
              variant="secondary"
