...
import { X, Calendar, DollarSign, CreditCard, Globe, Edit3, Trash2, RotateCcw, Play, AlertCircle, Eye, Clock, Tag } from 'lucide-react';
      ...
      >
        <div className="h-full flex flex-col">
          ...
          <div className="flex-1 overflow-y-auto p-6 space-y-6">
            ...
            <Card style={cardStyles} className="border-0">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <label className={`text-xs font-medium ${isDarkMode ? 'text-gray-400' : 'text-gray-500'} uppercase tracking-wide`}>
                      Category
                    </label>
            ...
            {/* Variable Pricing */}
            {subscription.variablePricing?.upcomingChanges && subscription.variablePricing.upcomingChanges.length > 0 && (
              <Card style={cardStyles} className="border-0">
                <CardHeader className="pb-3">
                  <CardTitle className={`text-lg ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>
                ...
                <CardContent className="space-y-3">
                  {subscription.variablePricing.upcomingChanges.map((change, index) => (
                    <div key={index} className="flex items-center justify-between p-3 rounded-lg bg-yellow-50 dark:bg-yellow-900/20">
                      <div>
                        <p className={`font-medium ${isDarkMode ? 'text-gray-100' : 'text-gray-900'}`}>
          ...
          {/* Action Buttons */}
          <div className="p-6 border-t space-y-3" style={{
            borderColor: isDarkMode ? 'rgba(75, 85, 99, 0.2)' : 'rgba(255, 255, 255, 0.2)'
          }}>
