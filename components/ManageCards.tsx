...
export function ManageCards({ cards, onAddCard, onEditCard, onDeleteCard, onSetDefault }: ManageCardsProps) {
  ...
  const handleDelete = (card: PaymentCard) => {
    if (confirm(`Are you sure you want to delete ${card.nickname}? This action cannot be undone.`)) {
          ...
          <Dialog open={isFormOpen} onOpenChange={setIsFormOpen}>
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <Label htmlFor="nickname" className={textOnGlass}>Card Nickname</Label>
                  <Input
                    id="nickname"
                ...
                <div>
                  <Label htmlFor="lastFour" className={textOnGlass}>Last 4 Digits</Label>
                  <Input
                    id="lastFour"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="type" className={textOnGlass}>Card Type</Label>
                    <Select
                      value={formData.type}
                  ...
                  <div>
                    <Label htmlFor="issuer" className={textOnGlass}>Issuer</Label>
                    <Select
                ...
                <div>
                  <Label htmlFor="color" className={textOnGlass}>Card Color</Label>
            ...
            >
              ...
              <div className="p-6">
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className={`${textSecondary} font-mono tracking-wider`}>****{card.lastFour}</span>
                    <Badge 
                      variant="outline" 
                      className={`text-xs ${
                        isDarkMode 
