...
import { Calendar, Target, TrendingUp, AlertTriangle, Plus, DollarSign, PiggyBank, Calculator } from 'lucide-react';
...
import { FullSubscription, BudgetCategory, WeeklyAllocation, FinancialRoutingSettings, DEFAULT_BUDGET_CATEGORIES } from '../types/subscription';
...
export function PlanningTab({ 
  ...
  const weeklyBreakdown = useMemo(() => {
    ...
    weeklyPayments.forEach(sub => {
      ...
      breakdown[category].total += calculateWeeklyAmount(validatedSub.price, validatedSub.frequency, validatedSub.variablePricing);
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <Badge variant="outline" className={`${textColors.secondary} ${isStealthOps ? 'font-mono' : ''}`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            >
              ...
              <CardContent>
                ...
                <Progress 
                  value={financialSettings.weeklyIncome > 0 ? (totalWeeklySpending / financialSettings.weeklyIncome) * 100 : 0} 
                  className="mt-2 h-2"
                />
              </CardContent>
            </Card>
            ...
            >
              ...
              <CardContent>
                <div className="space-y-4">
                  {weeklyBreakdown.map(({ category, total, count, subscriptions: categorySubscriptions }) => (
                      ...
                      <div className="flex flex-wrap gap-1">
                        {categorySubscriptions.map(sub => (
                          ...
                          >
                            {sub.name} - {(() => {
                              const validatedSub = validateSubscriptionForCalculations(sub);
                              return formatCurrency(calculateWeeklyAmount(validatedSub.price, validatedSub.frequency, validatedSub.variablePricing));
                            })()}
                          </Badge>
                        ))}
                      </div>
