...
import { Bot, Zap, Bell, TrendingUp, AlertTriangle, Calendar, DollarSign, Target, Settings, Play, Pause, RotateCcw } from 'lucide-react';
...
interface AutomationRule {
  id: string;
  name: string;
  type: 'price_alert' | 'renewal_reminder' | 'usage_optimizer' | 'budget_guard' | 'duplicate_detector';
  isActive: boolean;
  trigger: {
    condition: string;
    threshold?: number;
...
export function SmartAutomationTab({ subscriptions, cards, onAutomationTrigger }: SmartAutomationTabProps) {
  ...
  useEffect(() => {
    const generateInsights = () => {
      ...
      if (maxCategoryCount > 3) {
        const dominantCategory = Object.entries(categoryCount).find(([,count]) => count === maxCategoryCount)?.[0];
        insights.push({
  ...
  const getAutomationIcon = (type: string) => {
    switch (type) {
      ...
      case 'budget_guard': return Target;
      case 'duplicate_detector': return TrendingUp;
      case 'usage_optimizer': return RotateCcw;
      default: return Bot;
    }
  };
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <Card className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-950 dark:to-purple-900 border-purple-200 dark:border-purple-800">
          <CardContent className="p-4">
            ...
            <div className="text-xs text-purple-600 dark:text-purple-400">of {automationRules.length} total</div>
          </CardContent>
        </Card>
        ...
        <TabsContent value="rules">
          <div className="space-y-4">
            {automationRules.map((rule) => {
              ...
              return (
                <Card key={rule.id} className={`${rule.isActive ? 'border-green-200 bg-green-50/30 dark:bg-green-950/30' : 'opacity-60'}`}>
                        ...
                        {rule.trigger.threshold && (
                          <div className="flex items-center space-x-2">
                            ...
                            <span className="text-xs text-muted-foreground">
                              {rule.type === 'price_alert' ? '$' : rule.type === 'usage_optimizer' ? '%' : ''}
                            </span>
                          </div>
                        )}
            ...
            {automationInsights.length === 0 ? (
              <Card>
                <CardContent className="text-center py-8">
                  ...
                  <p className="text-muted-foreground">
                    No automation insights available yet. AI will analyze your patterns and suggest optimizations.
                  </p>
                </CardContent>
              </Card>
            ) : (
                  ...
                  <CardContent className="pt-0">
                    <div className="flex items-center justify-between">
                      <div className="space-y-1">
                        ...
                        <div className="text-sm text-muted-foreground">{insight.automationType}</div>
                      </div>
                      <Button size="sm">
                        <Zap className="w-3 h-3 mr-1" />
        ...
        <TabsContent value="scheduler">
          <div className="space-y-6">
            <Alert>
              ...
              <AlertDescription>
                Smart Scheduler analyzes your cash flow and automatically suggests optimal renewal dates to spread costs evenly.
              </AlertDescription>
            </Alert>
                ...
                <CardContent>
                  <div className="space-y-4">
                    <div className="text-center p-4 bg-muted/50 rounded-lg">
                      ...
                      <div className="text-sm text-muted-foreground">Improvement in cash flow smoothness</div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-muted-foreground">Schedule for August 15th (payday +3)</div>
                      </div>
                    </div>
                  ...
                  <div className="flex items-center justify-between p-3 border rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        ...
                        <div className="text-xs text-muted-foreground">Scan for overlapping productivity tools</div>
                      </div>
                    </div>
