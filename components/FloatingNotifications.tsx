    ...
    <div className="fixed bottom-20 right-4 z-50">
      ...
      {isOpen && (
        <>
          ...
          >
            <div className={`p-4 ${
              isStealthOps ? 'border-b border-gray-600' : 'border-b border-gray-200 dark:border-gray-700'
            }`}>
                    ...
                    >
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          <div className={`text-sm mt-1 ${textColors.muted} line-clamp-2 ${
                            isStealthOps ? 'font-mono tracking-wide' : ''
                          }`}>
      ...
      >
        ...
        {unreadCount > 0 && (
          <div className={`absolute -top-1 -right-1 h-5 w-5 text-xs font-medium shadow-lg flex items-center justify-center ${
            isStealthOps 
